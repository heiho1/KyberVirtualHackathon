// derived from https://github.com/Uniswap/uniswap-frontend/blob/beta/src/contexts/Allowances.js
import React, {
  createContext,
  useContext,
  useReducer,
...
import { getTokenAllowance } from '../../utils/tokens';
import { isAddress } from '../../utils/contracts';
import { safeAccess } from '../zap_uniswap';
